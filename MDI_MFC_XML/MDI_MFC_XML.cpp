...
// MDI_MFC_XML.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMDIMFCXMLApp, CWinAppEx)
	//ON_COMMAND(ID_APP_ABOUT, &CMDIMFCXMLApp::OnAppAbout)
...
// Создание CMDIMFCXMLApp

CMDIMFCXMLApp::CMDIMFCXMLApp() noexcept
{
	...
	SetAppID(_T("MDIMFCXML.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMDIMFCXMLApp

CMDIMFCXMLApp theApp;


// Инициализация CMDIMFCXMLApp

BOOL CMDIMFCXMLApp::InitInstance()
{
	m_bHiColorIcons = TRUE;
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MDIMFCXMLTYPE,
		RUNTIME_CLASS(CMDIMFCXMLDoc),
...
int CMDIMFCXMLApp::ExitInstance()
{
...
// Обработчики сообщений CMDIMFCXMLApp
...
void CMDIMFCXMLApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CMDIMFCXMLApp

void CMDIMFCXMLApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMDIMFCXMLApp::LoadCustomState()
{
}

void CMDIMFCXMLApp::SaveCustomState()
{
}
